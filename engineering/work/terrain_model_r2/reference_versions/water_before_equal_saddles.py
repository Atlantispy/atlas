...
def fill_spill_merge(bed_m, cell_area_m2, basins, leaf_water_m3):
    ...
    for name in order:
        ...
        if node["children"]:
            ...
            if merge is None or merge != by_id[right]["spill"] or spill is not None and spill <= merge:
    ...
    return {"water_depth_m": depth, "water_surface_m": surface, "active_pools": pools,
