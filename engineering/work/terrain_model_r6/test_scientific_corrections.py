...
class PreservationTests(unittest.TestCase):
    ...
    def test_executed_hillslope_is_exact_repaired_source_not_old_global(self):
        self.assertEqual(Path(hillslope_binding.kernel.__file__).parent.name,'terrain_model_r2_repair_r1')
        self.assertIsNot(hillslope_binding.kernel,r4_io.io)
        self.assertEqual(next(r['sha256'] for r in hillslope_binding.verify() if r['name'].endswith('/core.py')),
                         'b91a65135aaa49e67da5c26388d0d72142d32ee1229ec5d2e5da405b8c16fb45')
