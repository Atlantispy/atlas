...
def _resolve_profile(
    *, workspace_root: Path, generator_root: Path, task: str,
    ...
    if output_directory and task not in {"ExportTables", "Full", "Smoke", "Refine10m", "Physical10m", "Population"}:
    ...
    if task in {"Refine10m", "Physical10m", "Population"} and not output_directory:
